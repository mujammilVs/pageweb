...
import digidoxbanner from "../../assets/digidox-banner.webp";
    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            [
              "Central repository for storing electronic documents in multiple formats",
              "Management & Archival",
              "Easy & dynamic document Indexing",
              "Detailed Document Version control",
